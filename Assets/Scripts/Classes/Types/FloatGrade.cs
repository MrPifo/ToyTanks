...
public struct FloatGrade {
	...
	/// <summary>
	/// Medium Difficulty is treated as default
	/// </summary>
	[SerializeField]
	...
	public FloatGrade(Difficulty diff = Difficulty.Medium) {
		value = 0;
		_difficulty = diff;
		easyOverride = 0;
		hardOverride = 0;
	...
	public FloatGrade(float value, Difficulty diff = Difficulty.Medium) {
		this.value = value;
		_difficulty = diff;
		easyOverride = 0;
		hardOverride = 0;
...
public class FloatGradePropertyDrawer : PropertyDrawer {
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
		...
		//EditorGUI.LabelField(new Rect(baseValueRect.x + baseValueRect.width + 5, baseValueRect.y, baseValueRect.width, baseValueRect.height), "= " + property.FindPropertyRelative("Value"));
		if(showExtraProps) {

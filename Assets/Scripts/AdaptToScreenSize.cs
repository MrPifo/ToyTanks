...
public class AdaptToScreenSize : MonoBehaviour {
	...
	public float _wantedAspectRatio = 1.7066666f;
	static float wantedAspectRatio;
	static Camera cam;
	static Camera backgroundCam;
	static AdaptToScreenSize Instance;
	...
	public void UpAspectRatio() {
		Instance._wantedAspectRatio += 0.1f;
	}

	public void DownAspectRatio() {
		Instance._wantedAspectRatio -= 0.1f;
	}
}